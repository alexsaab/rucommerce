    ...
    public function getCustomersWithMostSales($limit = null): Collection
    {
        ...
        return $this->orderRepository
            ...
            ->addSelect(
                ...
                DB::raw('orders.customer_first_name || \' \' || orders.customer_last_name as full_name'),
            ...
            ->groupBy(
                ...
                DB::raw("customer_email || '-' || customer_id")
            )
            ->orderByDesc('total')
            ->limit($limit)
            ->get();
    ...
    public function getCustomersWithMostReviews($limit = null): Collection
    {
        ...
        return $this->reviewRepository
            ...
            ->addSelect(
                ...
                DB::raw($tablePrefix.'customers.first_name || \' \' || '.$tablePrefix.'customers.last_name as full_name'),
            ...
            ->groupBy(
                ...
                'customers.last_name',
                DB::raw("email || '-' || ".$tablePrefix.'customers.id')
            )
            ->orderByDesc('reviews')
            ->limit($limit)
            ->get();
