...
class CustomerDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        ...
        $queryBuilder = DB::table('customers')
            ...
            ->addSelect(DB::raw($tablePrefix.'customers.first_name || \' \' || '.$tablePrefix.'customers.last_name as full_name'))
            ->groupBy(
                'customers.id',
                'customers.email',
                'customers.phone',
        ...
        $this->addFilter('full_name', DB::raw($tablePrefix.'customers.first_name || \' \' || '.$tablePrefix.'customers.last_name'));
